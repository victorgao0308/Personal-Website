...
const address = "http://localhost:3000/tetris";
const Tetris = () => {
  return (
    <div className="tetris">
      <div className="game-container hide-border">
        <div className="start-menu">
          <h3>Tetris but it's Kinda Scuffed</h3>
          <div className="btn-container">
            <button className="btn start">Start Game</button>
            <button className="btn hard-mode">Hard Mode</button>
          </div>
        </div>
        <div className="pause-menu hide-pause">
          <h3>Game is Paused</h3>
          <button className="btn resume-btn">Resume</button>
        </div>
        <div className="game-over hide-game-over">
          <h2>Game Over!</h2>
          <h3>
            Score: <div className="final-score"></div>
          </h3>
          <button className="btn play-again">Play Again</button>
        </div>
        <h3 className="hide-txt score-txt">
          Score: <div id="score">0</div>
        </h3>
        <h3 className="hide-txt level-txt">
          Level: <div id="level">1</div>
        </h3>
        <div className="spawn-zone"></div>
        <div className="playing-space hide-thin-border"></div>
...
window.addEventListener("load", () => {
  if (window.location.href === address) {
    ...
    function userMoveBlock(e) {
      let blocksArray = Array.from(document.querySelectorAll(".in-play"));
      let collision;
